...
if __name__ == "__main__":
    ...
    window.columnconfigure(index=[1, 3], weight=1)
    #window.columnconfigure(index=[1, 3], weight=1)
    ...
    txtid.grid(row=0, column=1, sticky="news", padx=2, pady=2, columnspan=4)
    tipid = Hovertip(txtid, "Unique record ID")

    lblplain = tk.Label(text="Plain text\nvulnerability: ")
    txtplain = tk.Text()
    ...
    txtplain.grid(row=1, column=1, sticky="news", padx=2, pady=2, columnspan=3)
    sclplain.grid(row=1, column=4, sticky="news", padx=2, pady=2)
    ...
    txtthreat.grid(row=2, column=1, sticky="news", padx=2, pady=2, columnspan=4)
    tipthreat = Hovertip(txtthreat, "Threat model description")

    lblweakclass = tk.Label(text="Weakness class:")
    ...
    lblvulnclass = tk.Label(text="Vulnerability class:")
    txtvulnclass = tk.Entry()
    lblvulnclass.grid(row=3, column=2, sticky="e", padx=2, pady=2)
    txtvulnclass.grid(row=3, column=3, sticky="news", padx=2, pady=2, columnspan=2)
    tipvulnclass = Hovertip(txtvulnclass, "e.g. CAPEC classification")

    lbltool = tk.Label(text="Tool: ")
    txttool = tk.Entry()
    lbltool.grid(row=4, column=0, sticky="e", padx=2, pady=2)
    txttool.grid(row=4, column=1, sticky="news", padx=2, pady=2, columnspan=4)
    ...
    lblassertions.grid(row=5, column=0, sticky="ne", padx=2, pady=2)
    txtassertions.grid(row=5, column=1, sticky="news", padx=2, pady=2, columnspan=3)
    sclassertions.grid(row=5, column=4, sticky="news", padx=2, pady=2)
    ...
    txtdesign = tk.Entry()
    lbldesign.grid(row=6, column=0, sticky="e", padx=2, pady=2)
    txtdesign.grid(row=6, column=1, sticky="news", padx=2, pady=2)
    ...
    txtorigin = tk.Entry()
    lblorigin.grid(row=6, column=2, sticky="e", padx=2, pady=2)
    txtorigin.grid(row=6, column=3, sticky="news", padx=2, pady=2, columnspan=2)
    ...
    lblreference.grid(row=7, column=0, sticky="e", padx=2, pady=2)
    txtreference.grid(row=7, column=1, sticky="news", padx=2, pady=2, columnspan=4)
    ...
    frmbuttons.grid(row=8, column=0, columnspan=5)
